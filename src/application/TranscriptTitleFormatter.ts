 ...
 */
export function slugifyTitle(title: string, maxLength: number = 80): string {
 ...
 */
export function formatTranscriptWithTitle(
  rawContent: string,
  ...
  const effectiveTitle =
    suggestedTitle && suggestedTitle.trim() ? suggestedTitle.trim() : "Untitled";
