...
- **fix: widen the title excerpt so the model can tell what language it is reading** — `pickExcerpt` fed 2000 characters starting at offset 600. On a recording that opened with a garbled round of introductions that window carried no usable signal, and a wholly Dutch transcript was titled in English in 0 of 3 runs. At 6000 characters the same transcript came back Dutch 3 of 3, and across six real Dutch transcripts the wider window scored 6 of 6 against 5 of 6 with no case getting worse.
